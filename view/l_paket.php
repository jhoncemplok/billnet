...
<table id="example1" class="table table-hover table-bordered table-striped dataTable">
	<thead>
      ...
      <tr>
        <td><?php echo $no++; ?></td>         
        <td><?php echo $lihat['kode_paket'] ?></td>    
        <td><?php echo $lihat['nama'] ?></td>     
        <td><?php echo "Rp ". number_format($lihat['harga'], 0, ',', '.'); ?></td>     
        <td align="center">
  				<!-- <a href="?page=paket&aksi=detail&id=<?php echo $lihat['id'] ;?>" class="btn btn-success btn-sm" title="Lihat Data"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span></a>  -->
