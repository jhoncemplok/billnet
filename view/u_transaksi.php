...
<form class="form-horizontal" method="POST" enctype="multipart/form-data">
  <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-3">
        <input type="text" class="form-control" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" id="inputku" name="nominal" value="<?php echo $lihat['nominal'] ;?>">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-3">
        <input type="file" id="exampleInputFile" name="bukti" value="<?php echo $lihat['bukti'] ;?>">
      </div>
    </div> 
    <?php }; ?>
...
?>
  ...
  if(isset($_POST['simpan'])){
    ...
    $query=mysql_query("UPDATE t_transaksi SET tgl_bayar='$_POST[tgl_bayar]', tgl_validasi=now(), nominal='$_POST[nominal]', status='$_POST[status]' WHERE id_transaksi='$_POST[id]'")or die(mysql_error());
    }else{
      $query=mysql_query("UPDATE t_transaksi SET tgl_bayar='$_POST[tgl_bayar]', nominal='$_POST[nominal]', bukti='$fileName' WHERE id_transaksi='$_POST[id]'")or die(mysql_error());
