<ul class="breadcrumb">
 ...
 $query=mysql_query("SELECT t_pelanggan.*, t_paket.nama as nama_paket, t_paket.harga from t_pelanggan left join t_paket on t_pelanggan.id_paket=t_paket.id_paket where t_pelanggan.id='$_GET[id]'");
  ...
  <div class="panel-body">
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-10">
							...
							<label class="col-sm-0 control-label"><?php echo $data['no_pelanggan']; ?></label>
						</div>
					  </div>					  
					  <div class="form-group">
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-10">
							<label class="col-sm-0 control-label">:</label>
							<label class="col-sm-0 control-label"><?php echo TanggalIndo($data['register_date']); ?></label>
						</div>
					  </div>
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-10">
							<label class="col-sm-0 control-label">:</label>
							<label class="col-sm-0 control-label"><?php echo $data['corporate']; ?></label>
						</div>
					  </div>
					  <div class="form-group">
