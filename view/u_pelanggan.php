...
<form class="form-horizontal" action="" method="POST">
  <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-3">
        <input type="text" class="form-control" readonly="" name="no_pelanggan" required value="<?php echo $lihat['no_pelanggan'] ;?>">
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-3">
        <input type="text" class="form-control" name="corporate" value="<?php echo $lihat['corporate'] ;?>">
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-sm-3">
        ...
        <?php
          ...
          while($r_pos=mysql_fetch_array($pos) ){
            ...
            <option <?php if( $lihat['id_paket']==$r_pos['id_paket']) {echo "selected"; } ?> value='<?php echo $r_pos['id_paket'] ;?>'><?php echo $r_pos['nama'] ;?> (<?php echo $r_pos['harga'] ;?>)</option>
          <?php
          };
          ?>
        </select>
...
?>
  ...
  if(isset($_POST['simpan'])){
    $query=mysql_query("UPDATE t_pelanggan SET no_pelanggan='$_POST[no_pelanggan]', nama='$_POST[nama]', alamat='$_POST[alamat]', corporate='$_POST[corporate]', no_hp='$_POST[telpon]', email='$_POST[email]', id_paket='$_POST[paket]' WHERE id='$_POST[id]'")or die(mysql_error());
