...
<div class="btn-group" >
  <a href="?page=admin&aksi=tambah" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Tambah Data</a>
</div>
  ...
  <thead>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td align="center">
          <a href="?page=admin&aksi=edit&id=<?php echo $lihat['id'] ;?>" class="btn btn-info btn-sm" title="Edit Data"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a> 
...
$hapus=mysql_query("DELETE from t_user WHERE id='$_GET[id]'") or die(mysql_error());
