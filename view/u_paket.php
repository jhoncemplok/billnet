...
<form class="form-horizontal" method="POST">
  <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-3">
        <input type="text" class="form-control" name="id_paket" readonly="" value="<?php echo $lihat['kode_paket'] ;?>">
      </div>
    </div>
    <div class="form-group">
   ...
   <input type="hidden" name="id" value="<?php echo $lihat['id_paket'] ;?>">
    <div class="form-group">
...
?>
  ...
  if(isset($_POST['simpan'])){
    $query=mysql_query("UPDATE t_paket SET kode_paket='$_POST[id_paket]', nama='$_POST[nama]', harga='$_POST[harga]' WHERE id_paket='$_POST[id]'")or die(mysql_error());
